      ...
      <section className="app-settings-content">
        ...
        {tab==='account'?<div className="settings-stack">
          ...
          <div className="setting-block"><div className="setting-title"><MonitorCog size={18}/><div><b>Yayın kalite profilleri</b><small>Yüksek değerler daha fazla upload, GPU ve alıcı tarafı decode gücü ister.</small></div></div><div className="media-quality-grid">
            ...
            <label>EKRAN PAYLAŞIMI<select aria-label="Ekran paylaşımı kalite profili" value={draft.screenQuality} onChange={e=>setDraft(p=>({...p,screenQuality:e.target.value as AppPreferences['screenQuality']}))}><option value="balanced">Otomatik</option><option value="source">Kaynak · native</option><option value="720p30">720p · 30 FPS</option><option value="1080p30">1080p · 30 FPS</option><option value="1080p60">1080p · 60 FPS</option><option value="1080p120">1080p · 120 FPS</option><option value="1080p144">1080p · 144 FPS</option><option value="1440p30">2K / 1440p · 30 FPS</option><option value="1440p60">2K / 1440p · 60 FPS</option><option value="1440p120">2K / 1440p · 120 FPS</option><option value="1440p144">2K / 1440p · 144 FPS</option></select><small>Seçili: {screenQualityLabel(draft.screenQuality)}</small></label>
          </div><div className="quality-note">Kaynak modu seçilen ekranı mümkün olduğunca native çözünürlükte gönderir. Açık kalite profilleri tek yüksek kalite katmanı yayınlar; 120/144 FPS hedef değerdir ve tarayıcı/GPU daha düşük gerçek FPS üretebilir.</div></div>
